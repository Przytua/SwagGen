...
`RequestBehaviour` is a protocol you can conform to with each function being optional. As the behaviours must work across multiple different request types, they only have access to a typed erased `APIRequestProtocol`.
...
public protocol RequestBehaviour {
    ...
    func onResponse(request: APIRequestProtocol, response: AnyResponse)
}
```
